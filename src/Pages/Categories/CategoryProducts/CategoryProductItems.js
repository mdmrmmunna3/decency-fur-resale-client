        ...
        <div>
            <div className="flex flex-col  p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
                ...
                <div>
                    ...
                    <h2 className="mb-1 text-xl font-semibold">Brand: {brand}</h2>
                    ...
                    <div className='flex justify-between my-2'>
                        <p className="mb-1 text-xl font-semibold">Orginal-Price: <span className='line-through text-red-400'>${orginal_price}</span></p>
                        <p className="mb-1 text-xl font-semibold">Resale-Price: ${resale_price}</p>
                    </div>
                    <div className='flex justify-between my-2'>
                        <p className="mb-1 text-xl font-semibold">year_of_purchase: <span>{year_of_purchase}</span></p>
                        <p className="mb-1 text-xl font-semibold">year_of_use: {year_of_use}</p>
                    </div>

                    <div className='flex justify-between my-2'>
                        <p className="mb-1 text-xl font-semibold">post_date: {post_date}</p>
